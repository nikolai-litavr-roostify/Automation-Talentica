...
WebUI.waitForElementClickable(findTestObject('Admin Dashboard/Invite Borrower/tab_Invite Borrower'), 3)

WebUI.click(findTestObject('Admin Dashboard/Invite Borrower/tab_Invite Borrower'))

WebUI.waitForElementVisible(findTestObject('Admin Dashboard/Invite Borrower/input_User Email'), 3)
